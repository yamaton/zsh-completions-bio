#compdef _agat_sp_filter_feature_from_keep_list.pl agat_sp_filter_feature_from_keep_list.pl

# Auto-generated with h2o


function _agat_sp_filter_feature_from_keep_list.pl {
    local line state
    ...
    _arguments -C \
        ...
        {--kl,--keep_list}'[Keep list. One value per line.]' \
